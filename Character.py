...
# character1 = Character("Striker")
# print(character1.__username) Can't take .__username outside the code, double underscore signifies that the variable will be inaccessible outside of the class.
